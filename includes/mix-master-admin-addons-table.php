...
class mix_master_admin_addons_table extends WP_List_Table {
	...
	if ( is_plugin_active( 'mix-master-addons/mix-master-addons.php' ) && file_exists($path) ) {
		...
		$mix_master_addon = "no";
		$mix_master_addon_get = '<a class="button-primary" href="https://wordpress.techgasp.com/mix-master/" target="_blank" title="Get Add-ons" style="float:left;">Get Add-ons</a>';
	}
?>
<table class="widefat" cellspacing="0">
	...
	<tbody>
		...
		<tr>
			...
			<td style="vertical-align:middle"><h3>Individual Shortcode</h3><p>Mixcloud Master uses TechGasp Wordpress Framework. The <b>Individual Shortcode</b> allows you to have a different customized mixcloud Player in each page or post. Easy to use it can be found when you edit a page or a post under the wordpress text editor. Once you have created your shortcode, Just insert the shortcode <b>[mix-master]</b> anywhere inside that text.</p></td>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$mix_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr class="alternate">
			...
			<td style="vertical-align:middle"><h3>Universal Shortcode</h3><p>Mixcloud Master uses TechGasp Wordpress Framework. The <b>Universal Shortcode</b> allows you to have the same mixcloud Player across different pages or posts. Easy to use it can be found right here under the Shortcodes menu. Once you have created your shortcode, Just insert the shortcode <b>[mix-master-un]</b> anywhere inside the text of your pages or posts.</p></td>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$mix_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr>
